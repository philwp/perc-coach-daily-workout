...
class AudioPlayer extends React.Component {
  ...
  render () {
    ...
    const tempo = this.props.playlist ? (
      activeIndex < 0 ? null : this.props.playlist[activeIndex].tempo
    ) : 'Please add a tempo';
    const sheetMusic = this.props.playlist ? (
      activeIndex < 0 ? null : this.props.playlist[activeIndex].sheetMusic ) :'Please load an img';
    const displayedTime = this.state.displayedTime;
    ...
    return (
      <div>
      <div className="audio_sheet_music">
          <img src={sheetMusic} />
        </div>
      <div
        id="audio_player"
      ...
      >
        ...
        <div id="tracklist_container" className="tracklist">
        </div>
      </div>
    );
  }
